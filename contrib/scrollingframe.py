...
# from https://github.com/ActiveState/code/blob/master/recipes/Python/580640_Scrolling_frame_mouse_wheel/recipe-580640.py
...
class Mousewheel_Support(object):
    ...
    def add_support_to(self, widget=None, xscrollbar=None, yscrollbar=None, what="units", horizontal_factor=None,
        ...
        # GeekSort Edit: switch x and y
        #main_scrollbar = yscrollbar if yscrollbar is not None else xscrollbar
        main_scrollbar = xscrollbar if xscrollbar is not None else yscrollbar
...
class Scrolling_Area(Frame, object):
    ...
    def __init__(self, master, width=None, anchor=N, height=None, mousewheel_speed=2, scroll_horizontally=True,
                 xscrollbar=None, scroll_vertically=True, yscrollbar=None, background=None, inner_frame=Frame
                 , use_sizegrip=True # GeekSort Edit: Adding sizegrip support
                 , **kw):
        ...
        # GeekSort Edit: Adding a sizegrip
        if use_sizegrip:
        ...
        # GeekSort Edit: Adding mouse drag
        self.innerframe.bind("<B1-Motion>", self._on_drag)
        self.innerframe.bind("<Button-1>", self._on_start_drag)
        self.innerframe.bind("<ButtonRelease-1>", self._on_stop_drag)
        # End Geeksort Edit
    ...
    def _on_start_drag(self, event):
        self.mouse_cursor_changed = True
        self.innerframe.configure(cursor="fleur")
