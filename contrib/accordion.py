...
# http://code.activestate.com/recipes/580781-metro-accordion-for-tkinter/
...
class Chord(Frame):
    ...
    def _open(self):
        ...
        animation = Animation(
            ...
            callback=self._on_finish_animation)

        animation.start_animation()
        
    def _on_finish_animation(self):
        self._is_animating = False
    ...
    def update_height(self):
        # if body's size changes, gotta poke this
        self.body.pack_propagate(True)
        self.body.update()
        self._body_height = self.body.winfo_reqheight()
        self.body.pack_propagate(False)
